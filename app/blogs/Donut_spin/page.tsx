...
export default async function ContextVaultPage() {
  ...
  return (
    <GridBackground3>
      ...
      <main className="mx-auto flex min-h-screen w-full flex-col gap-10 px-6 pb-16 pt-0">
        ...
        <section className="mx-auto w-full rounded-2xl border border-white/10 bg-black/25 p-6 backdrop-blur-sm">
