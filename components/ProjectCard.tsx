            ...
            <div className="flex items-center gap-2 shrink-0">
              {githubHref && (
                <a href={githubHref} target="_blank" rel="noopener noreferrer"
                  className="flex items-center justify-center w-8 h-8 transition-all duration-150 hover:scale-110">
                  <GithubIcon />
                </a>
              )}
              {deployedHref && (
                <a href={deployedHref} target="_blank" rel="noopener noreferrer"
                  className="flex items-center justify-center w-8 h-8 transition-all duration-150 hover:scale-110">
                  <ExternalLinkIcon />
                </a>
              )}
